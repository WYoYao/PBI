            ...
            _this[name] = function () {
                ...
                if (false) {
                    ...
                    return new Promise(function (resolve, rejcet) {
                        if (name == "GetProjectTransverseCompare") $("#globalloading").pshow()
                        pajax.post({
                            url: url,
...
// 查询管理分区列表
{
    name: "listManagementPartitionsService",
...
{
    // 获取表格信息
    name: "GetProjectTransverseCompare",
    url: "GetProjectTransverseCompare",
    argu: {},
    cb: function (argu) {
